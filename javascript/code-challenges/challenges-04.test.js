...
------------------------------------------------------------------------------------------------ */
function Meeting2(dayOfWeek, start, end) {
  this.dayOfWeek = dayOfWeek;
  this.start = start;
  this.end = end;
}
const meetings2 = [
  new Meeting2('Monday', '0900', '1000'),
  new Meeting2('Wednesday', '1300', '1500'),
  new Meeting2('Tuesday', '1145', '1315'),
  new Meeting2('Wednesday', '0930', '1000'),
  new Meeting2('Monday', '0900', '0945'),
  new Meeting2('Friday', '1200', '1345'),
];
...
describe('Testing challenge 13', () => {
  test('It should sort meetings by when they happen', () => {
    expect(sortSchedule(meetings2)).toStrictEqual([
      new Meeting2('Monday', '0900', '1000'),
      new Meeting2('Monday', '0900', '0945'),
      new Meeting2('Tuesday', '1145', '1315'),
      new Meeting2('Wednesday', '1300', '1500'),
