...
const addExclamation = (arr) => {
  // Solution code here...
  let newAdd=[]
  arr.forEach(element=> newAdd.push(element+"!"))
  return newAdd;
};
...
const allUpperCase = (arr) => {
  // Solution code here...
  let allUpp=[];
  arr.forEach(element=>allUpp.push(element.toUpperCase()))
  return allUpp;
};
...
const speaker = (words, callback) => {
  // Solution code here...
  let newWow=[]
  words.forEach(element=>newWow.push(callback(element)))
  return newWow
};
...
const addNumbers = (num, arr, times, callback) => {
  ...
  myTimes.forEach(()=>callback(arr,num))
  return arr
};
