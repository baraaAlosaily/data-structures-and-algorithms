...
const isCapitalized = (str) => {
  // Solution code here...
  let vlaidators = /[A-Z][a-z]*/g;
  let matchWs = str.match(vlaidators);
  return matchWs || [];
};
...
const citiesAtoJ = (arr) => {
  // Solution code here...
  let vlaidator = /^[A-J]/;
  let newArr = arr.filter((element) => vlaidator.test(element));
  return newArr;
};
